...
mkdir -p "$DIR_PRUEBA/con espacio"
mkdir -p "$DIR_PRUEBA/con espacio/espacio dos"
...
# Duplicados en directorio con espacios
echo "hola" > "$DIR_PRUEBA/con espacio/test.txt"
echo "hola" > "$DIR_PRUEBA/con espacio/espacio dos/test.txt"

echo "Estructura creada. Podés probar con los siguientes casos:"
echo "IMPORTANTE: Introduzca las rutas entre comillas ("") para evitar resultados inconsistentes..."
echo "Por ejemplo: ./ejercicio3.sh --directorio \"$DIR_PRUEBA/hay espacios\" "
echo ""
...
echo "  ./ejercicio3.sh"
echo ""
echo "  # Caso 5: directorio con espacios"
echo "  ./ejercicio3.sh --directorio \"/tmp/prueba_ej3/con espacio\""
echo ""
echo "  # Caso 6: directorio inexistente"
echo "  ./ejercicio3.sh --directorio /ruta/inexistente"
echo ""
echo "  # Caso 7: parámetro inválido"
